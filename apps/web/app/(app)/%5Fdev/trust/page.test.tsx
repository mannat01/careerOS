...
const liveBodies: Record<string, unknown> = {
  '/v1/me': { user: { id: '00000000-0000-4000-8000-000000000001', email: 'dev@careeros.local', authProviderId: 'dev-user', subscriptionTier: 'pro', status: 'active', onboardingCompletedAt: now, createdAt: now, updatedAt: now }, settings: { userId: '00000000-0000-4000-8000-000000000001', autonomyDefaults: { 'briefing.item.execute': 'yellow' }, quietHours: null, briefingSchedule: null, sourcePrefs: {}, dataUseOptIns: { training: false, crossUserIntel: false }, createdAt: now, updatedAt: now }, onboarding: { status: 'complete', completedAt: now } },
  ...
  '/v1/opportunities/opportunity-1/match': { status: 'ok', opportunityId: 'opportunity-1', overall: 87, subscores: [{ key: 'skills', value: 90 }], explanation: 'Strong overlap from seeded evidence.', evidenceRefs: ['experience:1'], modelVersion: 'match-v1' },
