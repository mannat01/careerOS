...
const PROV_COLOR: Record<Provenance, string> = {
  ...
  demonstrated: 'border-confidence-high text-confidence-high',
  inferred: 'border-confidence-med text-confidence-med',
  summarized: 'border-border-strong text-text-secondary',
};
